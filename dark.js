<html lang="zh-CN"><head>
    ...
    <meta name="keywords" content="交个朋友, 老罗, 罗永浩, 老罗直播, 罗永浩直播, 抖音带货一哥">
    <meta name="description" content="“交个朋友”官方网站旨在为消费者和品牌商家之间搭建桥梁，让消费者得到实惠，让好产品找到需要的人。">
    <title>交个朋友 - 罗永浩抖音带货直播</title>
    <style>
      .wrapper {
        position: fixed;
        top: 0;
        ...
        background-image: url(http://os55a09yx.bkt.clouddn.com/mf/web-bg.jpg);
      ...
      .main {
        ...
        background-image: url(http://os55a09yx.bkt.clouddn.com/mf/web-main.png);
        background-origin: content-box;
        background-clip: content-box;
      ...
      @media screen and (max-width: 736px) {
        .wrapper {
          background-image: url(https://img01.yzcdn.cn/upload_files/2021/03/14/FpqFilbmRSR4hS0N2JeHAFHBVGLA.png);
          /* padding-bottom: 48px; */
        }
        .main {
          bottom: 48px;
